	...
	Global.project = {
		list: function(opt){
			...
			function callback(v) {
				...
				var state, date, enddate, moddate, pub, dev, id, idm, memo, overl, type, page;
				var d1, d2, d3, d4, d5, d6, d7, d8, d9, d10;
				var r1, r2, r3, r4;
				var d1_, d2_, d3_, d4_, d5_, d6_, d7_, d8_, d9_, d10_;
				var c1, c2, c3, c4, c5, c6, c7, c8, c9, c10;

				var	endsum = 0, delsum = 0, tstsum = 0, ingsum = 0, watsum = 0, chksum = 0, num = -1, refersum = 0, 
					ctg_state = [],
					ctg_pub = [],
					ctg_dev = [],
					ctg_date = [],
				...
				for (var i = 0; i < len; i++) {
					...
					page = dataExecel.list[i].page || '';
					id = dataExecel.list[i].id || '';
					idm = dataExecel.list[i].idm || '';
					type = dataExecel.list[i].type || '';
					...
					d9 = dataExecel.list[i].d9|| '';
					d10 = dataExecel.list[i].d10 || '';
					...
					(dataExecel.list[i].d1 === '' && dataExecel.list[i].d2 === '' && dataExecel.list[i].d3 === '' && dataExecel.list[i].d4 === '' && dataExecel.list[i].d5 === '' && dataExecel.list[i].d6 === '' && dataExecel.list[i].d7 === '') ?
						(d8 !== '') ? d8_ = dataExecel.list[i - 1 < 0 ? 0 : i].d8 : d8 = d8_ :
						(!!dataExecel.list[i - 1 < 0 ? 0 : i].d8) ? d8_ = dataExecel.list[i - 1 < 0 ? 0 : i].d8 : d8_ = '';
					
					(dataExecel.list[i].d1 === '' && dataExecel.list[i].d2 === '' && dataExecel.list[i].d3 === '' && dataExecel.list[i].d4 === '' && dataExecel.list[i].d5 === '' && dataExecel.list[i].d6 === '' && dataExecel.list[i].d7 === '' && dataExecel.list[i].d8 === '') ?
						(d9 !== '') ? d9_ = dataExecel.list[i - 1 < 0 ? 0 : i].d9 : d9 = d9_ :
						(!!dataExecel.list[i - 1 < 0 ? 0 : i].d9) ? d9_ = dataExecel.list[i - 1 < 0 ? 0 : i].d9 : d9_ = '';
					...
					!!dataExecel.list[i].d9 ? d9 = dataExecel.list[i].d9 : '';
					!!dataExecel.list[i].d9 ? d10 = dataExecel.list[i].d10 : '';
					...
					refersum = (state === "참고") ? refersum + 1 : refersum;
					var x = (i === 0) ? 0 : i - 1;
					...
					c9 = (dataExecel.list[i].d9 !== dataExecel.list[x].d9) ? ' c9' : '';
					c10 = (dataExecel.list[i].d10 !== dataExecel.list[x].d10) ? ' c10' : '';
					...
					cls = cls2 + c1 + c2 + c3 + c4 + c5 + c6 + c7 + c8 + c9 + c10;
					...
					if (state !== '제외' && i === 0) {
						...
						table += '<colgroup>';
						table += '<col style="width:70px;">';
						table += '<col style="width:60px;">';//일정
						table += '<col style="width:60px;">';//수정일
						table += '<col style="width:60px;">';//퍼블담당자
						table += '<col style="width:70px;">';
						table += '<col style="width:70px;">';
						table += '<col style="width:70px;">';
						...
						table += '<colgroup>';
						(dataExecel.list[i].d1 !== undefined) ? table += '<col style="width:60px">' : '';
						(dataExecel.list[i].d2 !== undefined) ? table += '<col style="width:80px">' : '';
						...
						(dataExecel.list[i].d7 !== undefined) ? table += '<col style="width:auto">' : '';
						(dataExecel.list[i].d8 !== undefined) ? table += '<col style="width:auto">' : '';
						(dataExecel.list[i].d9 !== undefined) ? table += '<col style="width:auto">' : '';
						(dataExecel.list[i].d10 !== undefined) ? table += '<col style="width:auto">' : '';
						table += '</colgroup>';
						// table += '<col style="width:auto">';//화면아이디
						...
						table += '<th scope="col">' + page + '</th>';
						table += '<th scope="col">접근성</th>';
						table += '<th scope="col">' + id + '</th>';
						table += '<th scope="col">화면ID(구/공통)</th>';
						...
						(dataExecel.list[i].d9 !== undefined) ? table += '<th scope="col">D9</th>' : '';
						(dataExecel.list[i].d10 !== undefined) ? table += '<th scope="col">D10</th>' : '';
						// table += '<th scope="col">' + memo + '</th>';
						// table += '<th scope="col">비고</th>';
						table += '</thead>';
						table += '<tbody>';
					} else if (state !== '제외') {
						num = num + 1;
						...
						var is_a11y = dev === '수정' ? 'a11y-on' : 'a11y-off';
	
						Global.state.device.mobile ?
							table += '<tr class="' + cls + ' ' + is_a11y + '" data-state="'+ state + '">' :
							table += '<tr class="' + cls + ' ' + is_a11y + '" data-state="'+ state + '">';
						...
						table += '<td class="moddate"><span>' + ((!!Number(moddate)) ? moddate.substring(4,10) : moddate) + '</span></td>';
						table += '<td class="name pub"><span>' + pub + '</span></td>';
						
						table += '<td class="name dev"><span>' + type + '</span></td>';
						table += '<td class="name dev"><span>' + page + '</span></td>';
						table += '<td class="name dev"><span>' + (dev === '미수정' ? '' : '수정') + '</span></td>';
						...
						if (id !== '') {
							...
							// 	table += '<td class="id ico_pg"><span><a href="#" class="ui-coding-link" onclick="TFUI.popup.open({link:\'' + ( root + '/' + id) + '.html\' })">' + id + '</a></span></td>';
							// } else {
								table += '<td class="id ico_pg disabled"><span><a class="ui-coding-link" href="' + ( root + '/' + id) + '.html" target="coding">' + id + '</a></span></td>';
							// }
							} else {
								table += '<td class="id ico_pg"><span><a class="ui-coding-link" href="' + ( root + '/' + id) + '.html" target="coding">' + id + '</a></span></td>';
							}
							
						} else {
							table += '<td class="id "><span></span></td>';	
						}

						// if (page == 'Popup') {
								
						// 	table += '<td class="name dev"><span><a href="#" class="ui-coding-link" onclick="TFUI.popup.open({link:\'' + ( root + '/' + memo) + '.html\' })">' + memo + '</a></span></td>';
						// } else {
							table += '<td class="name dev"><span><a class="ui-coding-link" href="' + ( root + '/' + memo) + '.html" target="coding">' + memo + '</a></span></td>';
						// }

						// table += '<td class="name dev"><span>' + memo + '</span></td>';
						...
						(dataExecel.list[i].d9 !== '') ? table += '<td class="d d9"><span>' + d8 + '</span></td>' : table += '<td class="d"></td>';
						(dataExecel.list[i].d10 !== '') ? table += '<td class="d d10"><span>' + d8 + '</span></td>' : table += '<td class="d"></td>';
						// (dataExecel.list[i].memo === '') ? table += '<td class="memo none"><span>' + memo + '</span></td>' : table += '<td class="memo"><span>' + memo + '</span></td>';

						// table += '<td class="name dev"><span></span></td>';
						table += '</tr>';
					} 
				...
				codinglist.innerHTML = '<div class="ui-codinglist-a"></div>';
				codinglist.querySelector('.ui-codinglist-a').innerHTML = table;
				table = '';

				var info = '<div class="ui-codinglist-header">';
				info += '<div class="group">';
				info += '<h1>'+subject+'</h1>';
				info += '<div class="flex-wrap" style="align-items: center;"><div style="margin-right:20px"><input type="checkbox" id="a11y" ><label class="lb-checkbox" for="a11y">접근성 수정</label></div> <div style="margin-right:20px"><input type="checkbox" id="wait" ><label class="lb-checkbox" for="wait">대기</label></div> <a href="홈메인.html">홈메인</a><a href="공통.html">공통</a><a href="나의자산_리서치.html">나의자산_리서치</a><a href="금융.html">금융</a><a href="연금.html">연금</a><a href="트레이딩.html">트레이딩</a><a href="고객서비스.html">고객서비스</a><a href="뱅킹.html">뱅킹</a><a href="이용안내.html">이용안내</a><a href="/truefriend/resources/퍼블일정관리.xlsx" target="_down">엑셀다운로드</a></div>';
				info += '<div class="btn-wrap"><button type="button" class="list-toggle btn-base" id="mobilePreview"><span>미리보기</span></button></div>';
				info += '</div>';
				...
				info += '<input type="search" data-id="projectListSrchCode" class="inp-base ui-inpcancel" value="" placeholder="검색어를 입력해주세요.">';
				info += '<button type="button" data-id="projectListSrchBtn" class="btn-mix-outlined"><span>검색</span></button>';
				info += '<button type="button" data-id="projectListSrchRe" class="btn-mix-outlined"><span>초기화</span></button>';
				
				info += '</div>';
				info += '</div>';

var ifr = '<div class="ui-codinglist-preview" data-device="desktop">';
...
var previewSelect = doc.querySelector('#previewSelect');
var uiCodingIframeWrap = doc.querySelector('.ui-codinglist-preview');
var bar = uiCodingIframeWrap.querySelector('.bar');
...
bar.addEventListener('mousedown', dragStart);
				...
				var a11y_check = document.querySelector('#a11y');

				a11y_check.addEventListener('change', function(){
					console.log(this.checked);
					var tr = document.querySelectorAll('.ally-off');
					if (this.checked) {
						document.querySelector('.ui-codinglist').classList.add('a11y-check');
						
					} else {
						document.querySelector('.ui-codinglist').classList.remove('a11y-check');
					}
				});

				var wait_check = document.querySelector('#wait');

				wait_check.addEventListener('change', function(){
					console.log(this.checked);
					var tr = document.querySelectorAll('.ally-off');
					if (this.checked) {
						document.querySelector('.ui-codinglist').classList.add('wait-check');
						
					} else {
						document.querySelector('.ui-codinglist').classList.remove('wait-check');
					}
				});
				...
				function dragStart(e) {
					cX = e.clientX;
					cY = e.clientY;
					var device = uiCodingIframeWrap.dataset.device;
					dataDevice = 0.8;
					uiCodingIframe.style.display = 'none';
					doc.addEventListener('mousemove', dragMove);
				}
				function dragMove(e) {
					var x = (cX - cX_ - e.clientX) * -1;
					var y = (cY - cY_ - e.clientY) * -1;
...
console.log(links);
for (var i = 0, len2 = links.length; i < len2; i++) {
	var that = links[i];
	...
	that.addEventListener('mouseover', pagePreview);
				...
				function verOn() {
					codinglist.classList.toggle('on-ver');
				}
				...
				function previewAct(){
					...
					iframeHtml.classList.add('guide-iframe');
				...
				var el_info = codinglist.querySelector('.ui-codinglist-info');
				...
				var el_bar = codinglist.querySelector('.ui-codinglist-state .bar');
				var srchCode = codinglist.querySelector('[data-id="projectListSrchCode"]');
				var srchBtn = codinglist.querySelector('[data-id="projectListSrchBtn"]');
				var srchBtnRe = codinglist.querySelector('[data-id="projectListSrchRe"]');
				...
				if (srchCode.value !== '') {
					var temp = codinglist.querySelectorAll('.ui-codinglist tbody tr td *:contains('+ srchCode.value +')');
					var trs = codinglist.querySelectorAll('tbody tr');
					...
					temp.closest('tr').style.display = 'table-cell';
				}

				srchBtnRe.addEventListener('click', function(){
					var wrap = this.closest('.ui-codinglist');
					var el = wrap.querySelector('tbody');
					...
					for (var i = 0, len = el_tr.length; i < len; i++) {
						var that = el_tr[i];
				...
				function srchAct(v){
					var k = v;
					var wrap = event.target.closest('.ui-codinglist');
					var el_tbody = wrap.querySelectorAll('tbody');
					console.log(el_tbody.length)
					
					for (var i = 0, len = el_tbody.length; i < len; i++) {
						var that_tbody = el_tbody[i];
						

						var el_td = that_tbody.querySelectorAll('td');
						var el_tr = that_tbody.querySelectorAll('tr');

						for (var j = 0, len = el_tr.length; j < len; j++) {
							var that = el_tr[j];
							that.classList.add('srch-hidden');
						}
	
						for (var j = 0, len = el_td.length; j < len; j++) {
							var that = el_td[j];
							var text = that.textContent;
							var el_tr2 = that.closest('tr');
